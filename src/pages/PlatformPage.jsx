...
const productLines = [
  ...
  { name: 'Oncodea / MMyeloma', role: 'First owned specialty margin', detail: 'Molecular fingerprinting is designed to identify cancer-associated signals before symptoms appear — from a simple blood draw. First wedge: multiple myeloma via world-renowned hospital collaboration. VERITY clinical trial in progress.', color: '#D7CFE6' },
